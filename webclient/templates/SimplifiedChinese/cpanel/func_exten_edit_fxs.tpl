<% include file="cpanel/func_header.inc.tpl" %>
	<h4>编辑FXS 模拟分机 <% $extension.accountcode %> 信息</h4>

<form name="do_exten_edit_fxs" method="POST" action="?action=do_exten_edit_fxs&accountcode=<% $extension.accountcode %>" target="takefire">
	<table border="0" cellspacing="0" style="margin: 20px">
		...
		<tr>
			<td height="30" align="left" style="padding-left: 10px;padding-right: 40px">FXS模拟通道</td>
			<td height="30"><input type="text" id="iptext1" name="devicestring" size="16" value="<% $extension.devicestring %>" readonly></td>
		</tr>
		<tr>
