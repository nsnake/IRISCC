...
<form name="do_router_add" method="POST" action="?action=do_router_add" target="takefire">
	...
	<table border="0" cellspacing="0" style="margin: 20px">
		...
		<tr>
			...
			<td height="80">用户拨打的号码是以 <input type="text" id="iptext1" name="match_callednum" size="8" value=""> 开头,长度为 <input type="text" id="iptext1" name="match_calledlen" size="2" value=""> 位.<br>从头删除掉 <input type="text" id="iptext1" name="replace_calledtrim" size="2" value=""> 位数字,同时补充 <input type="text" id="iptext1" name="replace_calledappend" size="8" value=""> 到这个号码上.</td>
		</tr>
		<tr>
			...
			<td colspan="3">
				<table border="0" cellspacing="0" id='advance' style='display:none'>
					...
					<tr>
						...
						<td height="60"><input type="text" id="iptext1" name="match_callergroup_groupname" size="8" value=""></td>
					</tr>
					<tr>
