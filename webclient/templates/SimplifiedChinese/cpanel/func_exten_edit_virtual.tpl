<% include file="cpanel/func_header.inc.tpl" %>
	<h4>编辑虚拟分机 <% $extension.accountcode %> 信息</h4>

<form name="do_exten_edit_virtual" method="POST" action="?action=do_exten_edit_virtual&accountcode=<% $extension.accountcode %>" target="takefire">
	<table border="0" cellspacing="0" style="margin: 20px">
		<tr>
			<td height="30" align="left" colspan="2"><img src="../images/icon/24.png">&nbsp;第二步 用户信息<span class="tipmsg" title='虚拟分机不是真实存在的分机,不能接打电话,但是可以用于语音信箱或其他特殊应用.' style="color: #0C8AD6;text-decoration: none;font-size: 12px"><img src="../images/icon/19.png">&nbsp;<b>虚拟分机帮助?</b></span></td>
		</tr>
		<tr>
