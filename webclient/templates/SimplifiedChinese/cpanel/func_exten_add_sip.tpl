...
<form name="do_exten_add_sip" method="POST" action="?action=do_exten_add_sip" target="takefire">
		...
		<tr>
			<td colspan="3">
				<table border="0" cellspacing="0" id='advance' style='display:none'>
					<tr>
						<td height="30" align="left" style="padding-left: 10px;padding-right: 40px"><img src="../images/icon/24.png">&nbsp;协议参数</td>
					</tr>
					<tr>
						<td height="30" align="center" width="100%" colspan="2"><hr size="1"></td>
					</tr>
					...
					<tr>
						...
						<td height="30"><input type="radio" value="yes" checked name="nat">Yes <input type="radio" value="no" name="nat">No</td>
					</tr>
					<tr>
						<td height="30" align='left' style="padding-left: 10px;padding-right: 40px">保活时长</td>
						<td height="30"><input type="text" id="iptext1" name="qualify" size="8" value="2000">毫秒</td>
					</tr>
					<tr>
					...
					<tr>
						<td height="30" align="left" style="padding-left: 10px;padding-right: 40px" style="padding-right: 40px">SIP协议转发</td>
						<td height="30"><input type="radio" value="yes" name="canreinvite">Yes <input type="radio" value="no" checked name="canreinvite">No</td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td height="30"><input type="text" id="iptext1" name="call-limit" size="4" value="1"> 个同时呼叫
						</td>
					</tr>
					<tr>
