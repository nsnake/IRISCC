...
$GLOBALS['locate']=new Localization($_SESSION['curuser']['country'],$_SESSION['curuser']['language'],'agent_queue_statistics');

require_once ("include/xajax.inc.php");

$xajax = new xajax("agent_queue_statistics.server.php");
