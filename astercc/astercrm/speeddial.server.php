...
function createGrid($start = 0, $limit = 1, $filter = null, $content = null, $order = null, $divName = "grid", $ordering = "",$stype=array()){
	...
	if($_SESSION['curuser']['usertype'] != 'admin' && $_SESSION['curuser']['usertype'] != 'groupadmin') {
		if($_SESSION['curuser']['privileges']['speeddial']['delete']) {
			$deleteFlag = 1;
		} else {
			$deleteFlag = 0;
		}
		if($_SESSION['curuser']['privileges']['speeddial']['edit']) {
			$editFlag = 1;
		}else {
			$editFlag = 0;
		}
	...
	// Change here by the name of fields of its database table
		...
		$rowc[] = $row['creby'];
		$rowc[] = $row['cretime'];
		$table->addRow("speeddial",$rowc,$editFlag,$deleteFlag,0,$divName,$fields);
 	}
 	// End Editable Zone
