...
<html>
	<head>
		...
		<script type="text/javascript">
			var hourShow = "<?php echo $locate->Translate('hour')?>";
			var minShow = "<?php echo $locate->Translate('min')?>";
			var secShow = "<?php echo $locate->Translate('sec')?>";
			var inputBtn = "<?php echo $locate->Translate('ok')?>";
		</script>
