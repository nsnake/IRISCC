...
<html>
	...
	<div id="divActive" name="divActive">
		<input type="button" value="AgentQueueStatistics" id="btnAgentQueueStatistics" name="btnAgentQueueStatistics" onClick="window.location='agent_queue_statistics.php';" />
	</div>
